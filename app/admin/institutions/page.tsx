    ...
    <>
      ...
      <div className="mb-5 flex flex-wrap items-end gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-[#0B1D3A] px-4 py-2.5 text-[12px] font-bold text-white transition hover:bg-[#132848] disabled:bg-slate-300"
        >
                ...
                <button
                  ...
                  className={`rounded-lg px-3 py-2 text-[11.5px] font-bold transition disabled:opacity-60 ${
                    inst.subscriptionActive
                      ...
                      : "bg-[#0B1D3A] text-white hover:bg-[#132848]"
                  }`}
                >
                  {savingId === inst.id
                    ? "..."
