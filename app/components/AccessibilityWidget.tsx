    ...
    <div ref={containerRef} className="fixed bottom-5 right-5 z-[100]" data-noinvert>
      {open && (
        <div className="mb-3 w-72 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl">
          <div className="flex items-center justify-between border-b border-slate-100 bg-[#0B1D3A] px-4 py-3">
      ...
      <button
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#0B1D3A] text-white shadow-xl ring-2 ring-white transition hover:scale-105"
      >
