        ...
        <div className="flex items-center justify-between rounded-full border border-slate-200/80 bg-white/70 px-4 py-3 shadow-sm backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-sm font-bold text-slate-900">Masuk ke portal</h1>
            </div>
          </div>
          <Link
            href="/"
          ...
          <Reveal>
            <section className="max-w-2xl">
              ...
              <h2 className="mt-6 text-4xl font-black leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
                Lanjutkan <span className="text-gradient">perjalanan kariermu</span>
              </h2>
              <p className="mt-5 max-w-xl text-base leading-7 text-slate-600 sm:text-lg">
                Pilih peranmu, masukkan email dan kata sandi, lalu kami arahkan ke
                halaman yang sesuai untukmu.
              </p>

              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                <InfoCard icon={Mail} title="Email" text="Identitas akunmu." />
                <InfoCard icon={UserRound} title="Peran" text="Siswa, konselor, admin." />
                <InfoCard icon={ShieldCheck} title="Aman" text="Sesi terenkripsi." />
              </div>
            </section>
          </Reveal>
              ...
              <div className="glass rounded-[30px] p-6 shadow-xl shadow-blue-500/10 sm:p-7">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h3 className="mt-1 text-xl font-bold text-slate-900">Masuk</h3>
                  </div>
